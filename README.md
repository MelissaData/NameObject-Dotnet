...
Depending on your target .NET framework, you may need to configure the powershell script. In order to do this, open up the `MelissaNameObjectWindowsDotnet.ps1` for editing, proceed to the bottom of the script where you will find this section of code.
